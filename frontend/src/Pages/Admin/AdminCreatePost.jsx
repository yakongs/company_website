...
const AdminCreatePost = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      await axios.post(`${import.meta.env.VITE_API_URL}/api/post`, postData, {
        withCredentials: true,
        headers: {
        ...
        <form className="space-y-4 sm:space-y-8" onSubmit={handleSubmit}>
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full rounded-lg border border-gray-300 shadow-sm focus:border-indigo-500 focus:outline-none text-base sm:text-lg p-2 sm:p-3"
              required
            />
          </div>
          ...
          <div>
            ...
            <input
              ...
              className="mt-1 block w-full text-base sm:text-lg text-gray-500 file:mr-2 sm:file:mr-4 file:py-2 sm:file:py-3 file:px-4 sm:file:px-6 file:rounded-lg file:border-0 file:text-base sm:file:text-lg file:font-semibold file:bg-indigo-50 file:text-indigo-700 hover:file:bg-indigo-100 cursor-pointer"
            />
          ...
          <div className="flex flex-col sm:flex-row sm:justify-end space-y-3 sm:space-y-0 sm:space-x-4 mt-8">
            <button
              type="submit"
              className="w-full sm:w-auto sm:px-6 py-2 sm:py-3 text-base sm:text-lg font-medium text-white bg-indigo-600 border-2 border-transparent rounded-lg shadow-sm hover:bg-indigo-700 focus:outline-none transition-all duration-300"
            >
              Save
            </button>
            <button
