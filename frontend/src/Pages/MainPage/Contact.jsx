    ...
    <div className="bg-white py-20 lg:py-48">
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="mt-12 text-center">
          <Link
            to="/contact"
            className="inline-block px-10 py-3 text-lg font-medium text-white bg-rose-700 rounded-lg shadow hover:bg-rose-800 transiton-all duration-300 ease-in-out hover:shadow-lg"
          >
            CONTACT US
          </Link>
        </div>
